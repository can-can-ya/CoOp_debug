...
```python
# Clone repo
git clone git@github.com:can-can-ya/CoOp_debug.git
cd CoOp_debug/Dassl

# Create a conda environment
conda create -y -n CoOp_debug python=3.8

# Activate the environment
conda activate CoOp_debug
...
# Install dependencies (in CoOp_debug/Dassl/)
pip install -r requirements.txt

# Install dependencies (in CoOp_debug/)
pip install -r ../requirements.txt
```
